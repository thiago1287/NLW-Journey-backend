/*
  ...
  - You are about to drop the column `tittle` on the `activities` table. All the data in the column will be lost.
  - You are about to drop the column `tittle` on the `links` table. All the data in the column will be lost.
